...
import DetailPage from "@/components/servicePage/DetailPage";
...
// app/react-native-developer/page.tsx (or /pages/react-native-developer.tsx if using Pages Router)
  ...
  const technologies = [
    {
      category: "Frontend & Backend",
      items: [
        "React Native", "Flutter", "Xamarin", "NativeScript",
        "Kotlin Native", "Swift (for iOS)", "Java (for Android)",
        "Node.js", "Django", "Ruby on Rails", "Laravel",
        "Flask", "ASP.NET", "Express.js",
      ],
    },
    {
      category: "Languages, Navigation & Configuration",
      items: [
        "JavaScript", "TypeScript", "React Navigation",
        ...
        <main className="relative flex flex-col-reverse lg:flex-row items-center justify-between px-5 max-w-screen-xl mx-auto gap-8">
          ...
          <div className="relative flex-shrink-0 w-full lg:w-1/2">
            {/* <img
              ...
              className="w-full rounded-lg lg:h-[70vh] sm:h-auto"
            /> */}
            <div className="bg-gray-400 w-full h-[70vh] rounded-lg flex items-center justify-center">
              {/* Placeholder */}
              <span>React Native Banner Image</span>
            </div>
          </div>
        </main>
      </div>
      ...
      <div className="bg-white text-black flex flex-wrap justify-center w-full mt-40 px-6">
        <div className="w-full lg:w-1/2 px-4">
          ...
          <div className="bg-gray-300 w-full h-80 rounded-lg flex items-center justify-center">
            {/* Placeholder */}
            <span>Technical Expertise Image</span>
          </div>
        </div>
